...
/// 将 `/path/to/CC Switch Lite.app/Contents/MacOS/CC Switch Lite` 转换为 `/path/to/CC Switch Lite.app`
#[cfg(target_os = "macos")]
...
mod tests {
    ...
    fn test_get_macos_app_bundle_path_valid() {
        ...
        assert_eq!(
            result,
            Some(std::path::PathBuf::from("/Applications/CC Switch Lite.app"))
        );
    }
    ...
    fn test_get_macos_app_bundle_path_with_spaces() {
        ...
        assert_eq!(
            ...
            Some(std::path::PathBuf::from(
                "/Users/test/My Apps/CC Switch Lite.app"
            ))
        );
    }
